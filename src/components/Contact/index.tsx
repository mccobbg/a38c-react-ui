...
const Contact = () => {
    ...
    const [validate, setValidate] = useState<ContactInfo>({
    ...
    const saveMessage = (event: any) => {
        ...
        validateContactInfo();
        if (validate.contactEmail === 'has-success' && 
            validate.contactName === 'has-success' &&
            validate.message === 'has-success' &&
            validate.subject === 'has-success') {
            ...
            <div className="contacts-9 section-gap">
                ...
                <div className="d-grid contact-view">
                    ...
                    <div className="cont-top margin-up">
                        ...
                        <div className="cont-right">
                        <h6>Email Us</h6>
                        <p><a href="mailto:support@eazybank.com" className="mail">support@eazybank.com</a></p>
                        </div>
                    </div>
                    <div className="cont-top margin-up">
                        <div className="cont-left text-center">
                    ...
                    <div className="map-content-9">
                        { contactId.length > 0 && (
                            <span className="text-success">Your message was submitted. Reference ID is ${contactId}</span>
                        )}
                        <form method="post" onSubmit={saveMessage}>
                            ...
                            <button type="submit" className="btn btn-contact" onSubmit={saveMessage}>Send Message</button>
                        </form>
                    </div>
                </div>
                </div>
